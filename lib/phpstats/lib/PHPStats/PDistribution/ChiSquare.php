...
*/
class ChiSquare implements ProbabilityDistributionInterface
{
    private $k;
     ...
     * @param ChiSquareCalculator instance of the calculator
     */
    public function __construct($k = 1.0,ChiSquareCalculator $cal)
    {
	$this->k          = $k;
	$this->calculator = $cal;
    }
    ...
    {
	return $this->calculator->getPdf($x, $this->k);
    }
    ...
    {
	return $this->calculator->getCdf($x, $this->k);
    }
    ...
    {
	return $this->calculator->getPpf($x, $this->k);
    }
    ...
    {
	return $this->calculator->getIsf($x, $this->k);
    }
