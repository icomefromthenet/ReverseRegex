...
*/
class DiscreteUniform implements ProbabilityDistributionInterface
{
    private $minimum;
    private $maximum;
    
    /**
      *  @var DiscreteUniformCalculator 
      */
     ...
     * @param DiscreteUniformCalculator $cal instance of a calculator
     */
    public function __construct($minimum = 0, $maximum = 1, DiscreteUniformCalculator $cal)
    {
    ...
    {
	return $this->calculator->getPmf($x, $this->minimum, $this->maximum);
    }
